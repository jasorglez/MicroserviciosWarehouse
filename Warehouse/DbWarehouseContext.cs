...
public partial class DbWarehouseContext : DbContext
{
    ...
    public virtual DbSet<ProductoTerminadoBomDelison> ProductoTerminadoBom { get; set; }
    public virtual DbSet<CostosConfigDelison> CostosConfig { get; set; }
...

    {
        ...
        modelBuilder.Entity<VwProveedoresParaMaterial>(entity =>
        {
            entity.HasNoKey();
            entity.ToView("vw_ProveedoresParaMaterial"); // 👈 nombre de la vista en la DB
        });
        ...
        modelBuilder.Entity<MaterialsByProviderView>(entity =>
        {
            entity.HasNoKey();
