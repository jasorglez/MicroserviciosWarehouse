...
builder.Services.AddSwaggerGen(c =>
{
   ...
   c.SwaggerDoc("v2.39", new OpenApiInfo { Title = "Microservicio Warehouse", Version = "v2.39 Mod. 09-09-2025 18:15, BSKG, Server 66.179.240.10" }); 
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v2.39/swagger.json", "Microservicio Warehouse V2.39");
