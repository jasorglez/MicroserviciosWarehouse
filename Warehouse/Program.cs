...
{
    c.SwaggerDoc("v1.9", new OpenApiInfo { Title = "Microservicio Warehouse", Version = "v1.9 Mod. 14-10-24 10:58" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1.9/swagger.json", "Microservicio Warehouse V1.9");
