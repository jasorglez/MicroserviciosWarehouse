...
builder.Services.AddSwaggerGen(c =>
{
   ...
   c.SwaggerDoc("v4.89", new OpenApiInfo { Title = "Microservicio Warehouse", Version = "v4.89 Mod. 2025-12-16 22:00, BSK, Server 66.179.240.10" }); 
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v4.89/swagger.json", "Microservicio Warehouse V4.89");
