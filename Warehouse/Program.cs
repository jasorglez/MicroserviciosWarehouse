...
builder.Services.AddSwaggerGen(c =>
{
   ...
   c.SwaggerDoc("v3.44", new OpenApiInfo { Title = "Microservicio Warehouse", Version = "v3.44 Mod. 21-09-2025 22:17, SBK, Server 66.179.240.10" }); 
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v3.44/swagger.json", "Microservicio Warehouse V3.44");
