 ...
 */
    ...
    c.SwaggerDoc("v2.20", new OpenApiInfo { Title = "Microservicio Warehouse", Version = "v2.20 Mod. 12-03-2025-03 05:09 am, SKG, Server 198.71.49.16" }); 
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v2.20/swagger.json", "Microservicio Warehouse V2.20");
